#!/usr/bin/env node
/**
 * Configures Supabase Auth custom SMTP to use Resend.
...
async function main() {
  ...
  const from = env.AUTH_EMAIL_FROM || "Nura <hello@usenura.app>";
  ...
  console.log("Supabase Auth SMTP now points at Resend.");
}
