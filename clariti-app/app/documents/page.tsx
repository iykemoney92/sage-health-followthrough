...
const documents = [
  ...
  {
    title: "Insurance EOB",
    subtitle: "BlueCross · Claim 8472",
    meta: "15 Jul 2026 · 2 pages",
    type: "Insurance",
    status: "Reviewed",
    tone: "violet",
    icon: ShieldCheck,
      ...
      <main className="documents-page-v2">
        ...
        <section className="documents-library-v2">
          ...
          <div className="documents-list-v2">
            {documents.map(({ title, subtitle, meta, type, status, tone, icon: Icon }) => (
              <Link href="/workspace" className="document-row-v2" key={title}>
