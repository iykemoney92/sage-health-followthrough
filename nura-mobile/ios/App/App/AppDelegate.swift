...
class AppDelegate: UIResponder, UIApplicationDelegate, MessagingDelegate {
    ...
    // token — that's what the backend actually sends to (see lib/integrations/push.ts
    // in nura-app), since Firebase proxies both platforms' pushes through one Admin
    // SDK call rather than the backend talking to APNs directly.
    ...
    // doesn't need any native-vs-web branching beyond isNativePlatform().
